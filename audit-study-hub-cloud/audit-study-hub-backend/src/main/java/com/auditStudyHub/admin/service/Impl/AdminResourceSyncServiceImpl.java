...
public class AdminResourceSyncServiceImpl implements AdminResourceSyncService {
    ...
    private ResourceDocument convertToDocument(TResource resource) {
        ...
        // 确保isDeleted字段被正确复制，以防BeanUtils在不同类型间复制失败
        document.setIsDeleted(resource.getIsDeleted());
    ...
    public void fullSync() {
        ...
        try {
            ...
            // 重新写入所有数据
            batchSyncToElasticsearch(resources);
